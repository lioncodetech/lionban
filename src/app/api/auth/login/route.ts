...
export async function POST(request: Request) {
  ...
  response.cookies.set("lionworkforce_session", await createSession(username), { httpOnly:true, secure:process.env.NODE_ENV==="production", sameSite:"strict", path:"/", maxAge:604800 });
  return response;
}
