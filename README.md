...
Ao criar ou editar um chamado, é possível anexar até cinco imagens. Quando duas ou mais imagens são enviadas, os nomes recebem sufixos sequenciais antes da extensão (`imagem1.png`, `imagem2.png` e assim por diante); o nome de uma imagem enviada sozinha é preservado. Clique na miniatura de uma imagem anexada para ampliá-la em um popup; o mesmo recurso está disponível na galeria do detalhe do chamado. Clique fora da imagem ou no botão de fechar para retornar.
